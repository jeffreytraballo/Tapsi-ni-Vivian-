...
ini_set('display_errors', 1);
	...
	if (!isset($_SESSION["cart_array"]) || count($_SESSION["cart_array"]) < 1) {
		...
		foreach ($_SESSION["cart_array"] as $each_item) { 
			...
			$cartTotal = (float)$cartTotal + $pricetotal;
...
<div class="overlay" id="overlay" onclick="hide_overlay()"></div>
		...
		<form method="post" action="" onSubmit="validate_input(); return false">
			...
			<div class="form_group">
				...
				<div class="form_group">
					...
					<label>Address</label>
					<input type="text" id="addr"  name="addr" value="PICK UP" readonly>
    ...
    <div class="on_footer_parallax">
        <p>&copy; <?php echo date("Y"); ?> <span>Tapsi ni Vivian at Bulaluhan</span>. All Rights Reserved</p>
    </div>
</div>
